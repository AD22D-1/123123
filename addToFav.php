<?php
    ...
    if($result = $mysqli -> query( $sqlstat))
    {
        ...
        if($count == 0 ){
            $sqlstatement ="insert into favouritelist (userid,contentid) values('$userid',$contentid)";
            //echo $sqlstatement;
            if ($mysqli ->query($sqlstatement))
            {
            echo " Add the item to your favourite list";
            ...
            header("Location:favourite.php?Fail1");
        }
